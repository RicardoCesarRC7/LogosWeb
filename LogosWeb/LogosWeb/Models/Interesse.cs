    ...
    public class Interesse
    {
        ...
        public Result SendEmail()
        {
            ...
            try
            {
                ...
                message.Body = $"<html><head></head><body><h1 style=\"text-align: center; padding-bottom: 15px; font-family: system-ui; \">Respostas do Formulário</h1><table style=\"text-align: left; margin: auto; font-family: monospace; font-size: large; width: 571px;\"><tr><td>Nome</td><td>{PrimeiroNome} {SegundoNome}</td></tr><tr><td>Email</td><td>{Email}</td></tr><tr><td>Telefone/Whatsapp</td><td>{Telefone}</td></tr><tr><td>Área(s) de interesse</td><td>{SetAreas()}</td></tr><tr><td>Curso(s) de interesse</td><td>{SetCursos()}</td></tr><tr><td>Formato(s) de interesse</td><td>{SetFormatos()}</td></tr><tr><td>Mensagem adicional</td><td>{Mensagem}</td></tr></table></body></html>";
